...
// RUN: mlir-opt -fold-memref-subview-ops -canonicalize |\
...
// RUN: mlir-opt -convert-vector-to-llvm -convert-memref-to-llvm -canonicalize -cse |\
// RUN: mlir-opt -pass-pipeline='gpu.module(strip-debuginfo,convert-gpu-to-nvvm,canonicalize,gpu-to-cubin)' \
// RUN: -gpu-to-llvm |\
