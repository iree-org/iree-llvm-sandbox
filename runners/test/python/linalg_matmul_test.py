...
expert_fuse_2_tile_1 = TestExpert([
    Fuse('matmul_on_tensors', 'linalg.matmul', tile_sizes=[8, 16]),
    Fuse('matmul_on_tensors', 'linalg.matmul', tile_sizes=[4, 4]),
...
expert_fuse_and_pad = TestExpert([
    ...
    Tile(
        ...
        hoist_padding=3),
    Vectorize('matmul_on_tensors', 'linalg.matmul'),
    Tile('matmul_on_tensors', 'linalg.fill', tile_sizes=[8, 32]),
    Vectorize('matmul_on_tensors', 'linalg.fill')
])
