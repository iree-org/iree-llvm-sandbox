...
def run_test():
  ...
  # later.
  test_desc = test_common.TestDesc("reduce", [dsl.S.M, dsl.S.N, dsl.S.O],
                                   [8, 4, 16], [dsl.S.M],
  ...
  for a3, a_so3, pw, iw, ps, vl in itertools.product(test_common.sparsities3(),
                                                     test_common.orderings3(),
                                                     test_common.bitwidths(),
                                                     test_common.bitwidths(),
                                                     test_common.pars(),
                                                     test_common.vls()):
    _test_reduce(test_desc, a3, a_so3, pw, iw, ps, vl)
