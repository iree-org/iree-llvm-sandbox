...
# find benchmarks -name "*data" | xargs -i sed -i s:{\"function_name\":\\n{\"function_name\":g {} && less benchmarks/depthwiseconv_1d_l3/depthwise_conv_1d_l3_repro.data


# L1 bandwidth bound.
# python ./tools/plot_benchmark.py --inputs /usr/local/google/home/ntv/github/iree-llvm-sandbox/benchmarks/l1_benchmarks/copy_2d_static_l1_repro.data,/usr/local/google/home/ntv/github/iree-llvm-sandbox/benchmarks/l1_benchmarks/transpose_2d_static_l1_repro.data,/usr/local/google/home/ntv/github/iree-llvm-sandbox/benchmarks/l1_benchmarks/row_reduction_2d_static_l1_repro.data,/usr/local/google/home/ntv/github/iree-llvm-sandbox/benchmarks/l1_benchmarks/column_reduction_2d_static_l1_repro.data --output bandwidth-bound-l1.pdf --plot_name "Bandwidth-bound Experiments (L1-bound)" --metric_to_plot "gbyte_per_s_per_iter"  --sizes_to_plot="m=10,n=32;m=10,n=48;m=20,n=32;m=8,n=96;m=20,n=48;m=12,n=96;m=10,n=128;m=16,n=96;m=12,n=144;m=110,n=16;m=16,n=128;m=64,n=32;m=20,n=128;m=20,n=144;m=90,n=32;m=190,n=16" --benchmarks_to_plot "copy_2d,transpose_2d,column_reduction_2d,row_reduction_2d"

# L2 bandwidth bound
# python ./tools/plot_benchmark.py --inputs /usr/local/google/home/ntv/github/iree-llvm-sandbox/benchmarks/l2_benchmarks/copy_2d_static_l2_repro.data,/usr/local/google/home/ntv/github/iree-llvm-sandbox/benchmarks/l2_benchmarks/transpose_2d_static_l2_repro.data,/usr/local/google/home/ntv/github/iree-llvm-sandbox/benchmarks/l2_benchmarks/row_reduction_2d_static_l2_repro.data,/usr/local/google/home/ntv/github/iree-llvm-sandbox/benchmarks/l2_benchmarks/column_reduction_2d_static_l2_repro.data --output bandwidth-bound-l2.pdf --plot_name "Bandwidth-bound Experiments (L1-bound)" --metric_to_plot "gbyte_per_s_per_iter"  --sizes_to_plot="m=12,n=960;m=16,n=960;m=50,n=320;m=12,n=1440;m=1100,n=16;m=20,n=960;m=160,n=160;m=900,n=32;m=200,n=160;m=160,n=240;m=200,n=240;m=160,n=320;m=200,n=320;m=6000,n=16;m=200,n=640;m=8000,n=16" --benchmarks_to_plot "copy_2d,transpose_2d,column_reduction_2d,row_reduction_2d"

# L3 bandwidth bound
# python ./tools/plot_benchmark.py --inputs /usr/local/google/home/ntv/github/iree-llvm-sandbox/benchmarks/l3_benchmarks/copy_2d_static_l3_repro.data,/usr/local/google/home/ntv/github/iree-llvm-sandbox/benchmarks/l3_benchmarks/transpose_2d_static_l3_repro.data,/usr/local/google/home/ntv/github/iree-llvm-sandbox/benchmarks/l3_benchmarks/row_reduction_2d_static_l3_repro.data,/usr/local/google/home/ntv/github/iree-llvm-sandbox/benchmarks/l3_benchmarks/column_reduction_2d_static_l3_repro.data --output bandwidth-bound-l3.pdf --plot_name "Bandwidth-bound Experiments (L1-bound)" --metric_to_plot "gbyte_per_s_per_iter"  --sizes_to_plot="m=250,n=960;m=5500,n=64;m=100,n=3840;m=3000,n=128;m=250,n=1920;m=100,n=5760;m=9500,n=64;m=250,n=2560;m=1000,n=640;m=250,n=3840;m=1000,n=960;m=800,n=1280;m=9500,n=128;m=1000,n=1280;m=12000,n=128;m=16000,n=128" --benchmarks_to_plot "copy_2d,transpose_2d,column_reduction_2d,row_reduction_2d"