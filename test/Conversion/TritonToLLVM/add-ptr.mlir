...
// CHECK-NEXT:    return
func.func public @kernel(%arg0: !tt.ptr<index>, %arg1: i32) {
...
// CHECK-DAG:     %[[V6:.*]] = arith.addi %[[V1]], %[[V5]] : tensor<1xindex>
// CHECK-NEXT:    return
func.func public @kernel(%arg0: !tt.ptr<index>) {
  %0 = arith.constant dense<[0]> : tensor<1xi32>
  %1 = tt.splat %arg0 : (!tt.ptr<index>) -> tensor<1x!tt.ptr<index>>
  %2 = tt.addptr %1, %0 : tensor<1x!tt.ptr<index>>, tensor<1xi32>
  return
}
