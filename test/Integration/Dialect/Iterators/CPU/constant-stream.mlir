...
func.func @main() {
  ...
  "iterators.sink"(%zero_to_three) : (!iterators.stream<tuple<i32>>) -> ()
  ...
  %empty = "iterators.constantstream"() { value = [] }
      : () -> (!iterators.stream<tuple<i32>>)
  "iterators.sink"(%empty) : (!iterators.stream<tuple<i32>>) -> ()
  // CHECK-LABEL: empty
  // CHECK-NEXT:  -
  ...
  %mixed_types = "iterators.constantstream"()
      ...
      : () -> (!iterators.stream<tuple<i1, i8, i16, i32, i64, f16, f32, f64>>)
  "iterators.sink"(%mixed_types) : (!iterators.stream<tuple<i1, i8, i16, i32, i64, f16, f32, f64>>) -> ()
