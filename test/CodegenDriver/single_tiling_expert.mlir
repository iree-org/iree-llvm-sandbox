// RUN: mlir-proto-opt -pass-pipeline="builtin.func(linalg-single-tiling-expert-driver{anchor-func=matmul anchor-op=linalg.matmul tile-sizes=10,20,30 vectorize})" -split-input-file %s | FileCheck %s
