...
/// Lamdba function to let user allocate memory needed for the lowering of
/// WarpSingleLaneOp.
/// The function needs to be return an allocation that the lowering can use as
...
/// so that each warp as its own allocation.
