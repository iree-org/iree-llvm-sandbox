...
// llvm-project/mlir/test/Transforms/decompose-call-graph-types.mlir.
// The test pass here has the same semantics as there but doesn't repeatedly
// (and unnecessarily) pack/unpack.

// RUN: iterators-opt %s -split-input-file \
