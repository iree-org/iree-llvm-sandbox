...
@linalg_structured_op
def transpose_3d_012(
    I=TensorDef(T, S.M, S.N, S.K), O=TensorDef(T, S.M, S.N, S.K, output=True)):
  domain(D.m, D.n, D.k)
  O[D.m, D.n, D.k] = I[D.m, D.n, D.k]


@linalg_structured_op
def transpose_3d_021(
    I=TensorDef(T, S.M, S.N, S.K), O=TensorDef(T, S.M, S.K, S.N, output=True)):
  domain(D.m, D.k, D.n)
  O[D.m, D.k, D.n] = I[D.m, D.n, D.k]


@linalg_structured_op
def transpose_3d_102(
    I=TensorDef(T, S.M, S.N, S.K), O=TensorDef(T, S.N, S.M, S.K, output=True)):
  domain(D.n, D.m, D.k)
  O[D.n, D.m, D.k] = I[D.m, D.n, D.k]


@linalg_structured_op
def transpose_3d_120(
    I=TensorDef(T, S.M, S.N, S.K), O=TensorDef(T, S.N, S.K, S.M, output=True)):
  domain(D.n, D.k, D.m)
  O[D.n, D.k, D.m] = I[D.m, D.n, D.k]


@linalg_structured_op
def transpose_3d_201(
    I=TensorDef(T, S.M, S.N, S.K), O=TensorDef(T, S.K, S.M, S.N, output=True)):
  domain(D.k, D.m, D.n)
  O[D.k, D.m, D.n] = I[D.m, D.n, D.k]


@linalg_structured_op
def transpose_3d_210(
    I=TensorDef(T, S.M, S.N, S.K), O=TensorDef(T, S.K, S.N, S.M, output=True)):
  domain(D.k, D.n, D.m)
  O[D.k, D.n, D.m] = I[D.m, D.n, D.k]


@linalg_structured_op
def transpose_4d_0123(
    I=TensorDef(T, S.M, S.N, S.K, S.L),
