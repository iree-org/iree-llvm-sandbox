...
def depthwise_conv_2d_nchw_chw(
    I=TensorDef(TV.T1, S.N, S.C, S.OH * S.SH + S.KH * S.DH, S.OW * S.SW + S.KW * S.DW),
  ...
  O[D.n, D.c, D.oh, D.ow] += (cast(U, I[D.n, D.c, D.oh * S.SH + D.kh * S.DH, D.ow * S.SW + D.kw * S.DW]) * cast(U, K[D.c, D.kh, D.kw]))


@linalg_structured_op
def depthwise_conv_2d_nchw_hwc(
    I=TensorDef(TV.T1, S.N, S.C, S.OH * S.SH + S.KH * S.DH, S.OW * S.SW + S.KW * S.DW),
  ...
  implements(ConvolutionOpInterface)
  domain(D.n, D.c, D.oh, D.ow, D.kh, D.kw)
  O[D.n, D.c, D.oh, D.ow] += (cast(U, I[D.n, D.c, D.oh * S.SH + D.kh * S.DH, D.ow * S.SW + D.kw * S.DW]) * cast(U, K[D.kh, D.kw, D.c]))


@linalg_structured_op
def depthwise_conv_2d_nhwc_chw(
    I=TensorDef(TV.T1, S.N, S.OH * S.SH + S.KH * S.DH, S.OW * S.SW + S.KW * S.DW, S.C),
    K=TensorDef(TV.T2, S.C, S.KH, S.KW),
  ...
  O[D.n, D.oh, D.ow, D.c] += (cast(U, I[D.n, D.oh * S.SH + D.kh * S.DH, D.ow * S.SW + D.kw * S.DW, D.c]) * cast(U, K[D.c, D.kh, D.kw]))
...
def depthwise_conv_2d_nhwc_hwc(
  ...
  implements(ConvolutionOpInterface)
  domain(D.n, D.oh, D.ow, D.c, D.kh, D.kw)
  O[D.n, D.oh, D.ow, D.c] += (cast(U, I[D.n, D.oh * S.SH + D.kh * S.DH, D.ow * S.SW + D.kw * S.DW, D.c]) * cast(U, K[D.kh, D.kw, D.c]))


@linalg_structured_op
def depthwise_conv_2d_cnhw_chw(
    I=TensorDef(TV.T1, S.C, S.N, S.OH * S.SH + S.KH * S.DH, S.OW * S.SW + S.KW * S.DW),
    K=TensorDef(TV.T2, S.C, S.KH, S.KW),
    O=TensorDef(U, S.C, S.N, S.OH, S.OW, output=True),
    strides=AttributeDef(S.SH, S.SW),
    dilations=AttributeDef(S.DH, S.DW)):
  implements(ConvolutionOpInterface)
  domain(D.c, D.n, D.oh, D.ow, D.kh, D.kw)
  O[D.c, D.n, D.oh, D.ow] += (cast(U, I[D.c, D.n, D.oh * S.SH + D.kh * S.DH, D.ow * S.SW + D.kw * S.DW]) * cast(U, K[D.c, D.kh, D.kw]))


@linalg_structured_op
def depthwise_conv_2d_cnhw_hwc(
    I=TensorDef(TV.T1, S.C, S.N, S.OH * S.SH + S.KH * S.DH, S.OW * S.SW + S.KW * S.DW),
    K=TensorDef(TV.T2, S.KH, S.KW, S.C),
    O=TensorDef(U, S.C, S.N, S.OH, S.OW, output=True),
    strides=AttributeDef(S.SH, S.SW),
  ...
  implements(ConvolutionOpInterface)
  domain(D.c, D.n, D.oh, D.ow, D.kh, D.kw)
  O[D.c, D.n, D.oh, D.ow] += (cast(U, I[D.c, D.n, D.oh * S.SH + D.kh * S.DH, D.ow * S.SW + D.kw * S.DW]) * cast(U, K[D.kh, D.kw, D.c]))


@linalg_structured_op
def depthwise_conv_2d_chwn_chw(
    I=TensorDef(TV.T1, S.C, S.OH * S.SH + S.KH * S.DH, S.OW * S.SW + S.KW * S.DW, S.N),
    K=TensorDef(TV.T2, S.C, S.KH, S.KW),
    O=TensorDef(U, S.C, S.OH, S.OW, S.N, output=True),
    strides=AttributeDef(S.SH, S.SW),
    dilations=AttributeDef(S.DH, S.DW)):
  implements(ConvolutionOpInterface)
  domain(D.c, D.oh, D.ow, D.n, D.kh, D.kw)
  O[D.c, D.oh, D.ow, D.n] += (cast(U, I[D.c, D.oh * S.SH + D.kh * S.DH, D.ow * S.SW + D.kw * S.DW, D.n]) * cast(U, K[D.c, D.kh, D.kw]))


@linalg_structured_op
def depthwise_conv_2d_chwn_hwc(
    I=TensorDef(TV.T1, S.C, S.OH * S.SH + S.KH * S.DH, S.OW * S.SW + S.KW * S.DW, S.N),
    K=TensorDef(TV.T2, S.KH, S.KW, S.C),
    O=TensorDef(U, S.C, S.OH, S.OW, S.N, output=True),
    strides=AttributeDef(S.SH, S.SW),
  ...
  implements(ConvolutionOpInterface)
  domain(D.c, D.oh, D.ow, D.n, D.kh, D.kw)
  O[D.c, D.oh, D.ow, D.n] += (cast(U, I[D.c, D.oh * S.SH + D.kh * S.DH, D.ow * S.SW + D.kw * S.DW, D.n]) * cast(U, K[D.kh, D.kw, D.c]))


@linalg_structured_op
def depthwise_conv_2d_hwnc_chw(
    I=TensorDef(TV.T1, S.OH * S.SH + S.KH * S.DH, S.OW * S.SW + S.KW * S.DW, S.N, S.C),
    K=TensorDef(TV.T2, S.C, S.KH, S.KW),
    O=TensorDef(U, S.OH, S.OW, S.N, S.C, output=True),
    strides=AttributeDef(S.SH, S.SW),
    dilations=AttributeDef(S.DH, S.DW)):
  implements(ConvolutionOpInterface)
  domain(D.oh, D.ow, D.n, D.c, D.kh, D.kw)
  O[D.oh, D.ow, D.n, D.c] += (cast(U, I[D.oh * S.SH + D.kh * S.DH, D.ow * S.SW + D.kw * S.DW, D.n, D.c]) * cast(U, K[D.c, D.kh, D.kw]))


@linalg_structured_op
def depthwise_conv_2d_hwnc_hwc(
    I=TensorDef(TV.T1, S.OH * S.SH + S.KH * S.DH, S.OW * S.SW + S.KW * S.DW, S.N, S.C),
    K=TensorDef(TV.T2, S.KH, S.KW, S.C),
    O=TensorDef(U, S.OH, S.OW, S.N, S.C, output=True),
    strides=AttributeDef(S.SH, S.SW),
  ...
  implements(ConvolutionOpInterface)
  domain(D.oh, D.ow, D.n, D.c, D.kh, D.kw)
  O[D.oh, D.ow, D.n, D.c] += (cast(U, I[D.oh * S.SH + D.kh * S.DH, D.ow * S.SW + D.kw * S.DW, D.n, D.c]) * cast(U, K[D.kh, D.kw, D.c]))


@linalg_structured_op
def depthwise_conv_2d_hwcn_chw(
    I=TensorDef(TV.T1, S.OH * S.SH + S.KH * S.DH, S.OW * S.SW + S.KW * S.DW, S.C, S.N),
    K=TensorDef(TV.T2, S.C, S.KH, S.KW),
    O=TensorDef(U, S.OH, S.OW, S.C, S.N, output=True),
    strides=AttributeDef(S.SH, S.SW),
    dilations=AttributeDef(S.DH, S.DW)):
  implements(ConvolutionOpInterface)
  domain(D.oh, D.ow, D.c, D.n, D.kh, D.kw)
  O[D.oh, D.ow, D.c, D.n] += (cast(U, I[D.oh * S.SH + D.kh * S.DH, D.ow * S.SW + D.kw * S.DW, D.c, D.n]) * cast(U, K[D.c, D.kh, D.kw]))


@linalg_structured_op
def depthwise_conv_2d_hwcn_hwc(
    I=TensorDef(TV.T1, S.OH * S.SH + S.KH * S.DH, S.OW * S.SW + S.KW * S.DW, S.C, S.N),
    K=TensorDef(TV.T2, S.KH, S.KW, S.C),
    O=TensorDef(U, S.OH, S.OW, S.C, S.N, output=True),
    strides=AttributeDef(S.SH, S.SW),
  ...
  implements(ConvolutionOpInterface)
  domain(D.oh, D.ow, D.c, D.n, D.kh, D.kw)
  O[D.oh, D.ow, D.c, D.n] += (cast(U, I[D.oh * S.SH + D.kh * S.DH, D.ow * S.SW + D.kw * S.DW, D.c, D.n]) * cast(U, K[D.kh, D.kw, D.c]))
