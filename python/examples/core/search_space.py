...
def extend_argument_parser(parser):
  ...
  parser.add_argument(
      ...
      'them =\"tile_sizes2=3,4,1 tile_sizes1=3,4,1 tile_sizes=3,4,1\"')
  parser.add_argument(
      '--tsize_value_range',
      type=str,
      default='tile_sizes2=8,33,8 tile_sizes1=64,513,32 tile_sizes=64,513,32',
      ...
      'them =\"tile_sizes2=32,129,16 tile_sizes1=64,513,32 tile_sizes=64,513,32\"')
  parser.add_argument(
